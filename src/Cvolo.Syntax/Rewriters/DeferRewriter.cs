...
public sealed class DeferRewriter : AstRewriterBase
{
	...
	private ExpressionSyntax CloneExpression(ExpressionSyntax expr)
	{
		return expr switch
		{
			...
			IntegerLiteralExpressionSyntax lit => new IntegerLiteralExpressionSyntax(lit.Span, lit.Value),
			DoubleLiteralExpressionSyntax lit => new DoubleLiteralExpressionSyntax(lit.Span, lit.Value),
